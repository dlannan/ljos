...
function main()
	...
	icons.facebook = {
			...
			enableImage=Gcairo:LoadImage("fbEnable", "lua/data/icons/generic_obj_ask_64.png"),
			disableImage=Gcairo:LoadImage("fbDisable", "lua/data/icons/generic_obj_box_64.png"),
	}

	icons.twitter = {
			x=270, y=60, enabled=0,
			enableImage=Gcairo:LoadImage("twEnable", "lua/data/icons/generic_obj_add_64.png"),
			disableImage=Gcairo:LoadImage("twDisable", "lua/data/icons/generic_obj_box_64.png"),
	}

	icons.google = {
			x=340, y=60, enabled=0,
			enableImage=Gcairo:LoadImage("ggEnable", "lua/data/icons/generic_obj_home_64.png"),
			disableImage=Gcairo:LoadImage("ggDisable", "lua/data/icons/generic_obj_box_64.png"),
	}
